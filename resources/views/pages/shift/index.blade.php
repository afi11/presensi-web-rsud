...
<div class="ibox mt-3">
    <div class="ibox-head">
        <div class="ibox-title">Data Shift Pegawai</div>
    </div>
    <div class="ibox-body">
        <a href="{{ route('shift.create') }}" class="btn btn-success mb-3 text-white"><span class="fa fa-plus"></span>
            Tambah Data</a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Apakah shift {{ $row->nama_shift }} akan dihapus ?
                            </div>
