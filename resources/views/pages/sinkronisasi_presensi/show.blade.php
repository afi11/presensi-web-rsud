...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Riwayat Presensi</li>
    </ol>
</div>
<div class="ibox mt-3">
    <div class="ibox-head">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-6">
                <form method="GET" id="frmAction">
                    <input type="month" name="bulanTahun" class="form-control" value="{{ $bulanTahun }}" />
...
var tabelHistoriPresensi = $("#datatable").DataTable({
    ajax: {
        url: '{{ url("fetch_log_presensi?ruangan=".Request::segment(2)) }}' + '&bulanTahun={{ $bulanTahun }}',
    },
    order: [
        [0, "asc"]
    ],
