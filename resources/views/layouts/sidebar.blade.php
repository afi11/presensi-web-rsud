    ...
    <div id="sidebar-collapse">
        <div class="admin-block d-flex">
            <div class="admin-info">
                <div class="font-strong">{{ Session::get('username') }}</div>
                <small>{{ Session::get('role') == 'admin' ? 'Administrator' : 'Kepegawaian'  }}</small>
            </div>
        </div>
        <ul class="side-menu metismenu">
            ...
            <li>
                ...
                <ul class="nav-2-level collapse in">
                    <li>
                        <a @if(Request::segment(1)=='pengguna' ) class="active" @endif
                            href="{{ url('pengguna') }}">Pengguna</a>
                    </li>
                    <li>
                        <a @if(Request::segment(1)=='pegawai' ) class="active" @endif
                            href="{{ url('pegawai') }}">Pegawai</a>
                    </li>
                    <li>
                        <a @if(Request::segment(1)=='ruangan' ) class="active" @endif
                            href="{{ url('ruangan') }}">Ruangan</a>
                    </li>
                    <li>
                        <a @if(Request::segment(1)=='waktu_reguler' ) class="active" @endif
                            href="{{ url('waktu_reguler') }}">Jam Kerja Reguler</a>
                    </li>
                    <li>
                        <a @if(Request::segment(1)=='jam_kerja_shift' ) class="active" @endif
                            href="{{ url('jam_kerja_shift') }}">Jam Kerja Shift</a>
                    </li>
                    <li>
                        <a @if(Request::segment(1)=='ruletelat' ) class="active" @endif
                            href="{{ url('ruletelat') }}">Rule Telat</a>
                    </li>
                    <!-- <li>
