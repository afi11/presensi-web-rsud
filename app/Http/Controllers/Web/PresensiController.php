    ...
    public function fetchHistoryPresensi(Request $request)
    {
        ...
        foreach($logPresensi as $row){
            array_push($data, [
                ...
                'telatMasuk' => sumTelatMasuk($request->ruangan, $row->code, $bulan),
                'lewatPulang' => sumLewatPulang($request->ruangan, $row->code, $bulan),
    ...
    public function prosesSinkronisasi(Request $request)
    {
        DB::transaction(function() use ($request) {
            ...
            foreach($result[0] as $row){
                ...
                if(strtoupper($row['1']) != crosCekPresensi($presensiSinkron->tgl_01)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_01 = 'X';
                    $ketTidakCocok .= " 1,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_01) != 1){
                    $presensiSinkron->hasil_tgl_01 = 'A';
                }

                if(strtoupper($row['2']) != crosCekPresensi($presensiSinkron->tgl_02)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_02 = 'X';
                    $ketTidakCocok .= " 2,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_02) != 1){
                    $presensiSinkron->hasil_tgl_02 = 'A';
                }

                if(strtoupper($row['3']) != crosCekPresensi($presensiSinkron->tgl_03)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_03 = 'X';
                    $ketTidakCocok .= " 3,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_03) != 1){
                    $presensiSinkron->hasil_tgl_03 = 'A';
                }

                if(strtoupper($row['4']) != crosCekPresensi($presensiSinkron->tgl_04)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_04 = 'X';
                    $ketTidakCocok .= " 4,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_04) != 1){
                    $presensiSinkron->hasil_tgl_04 = 'A';
                }

                if(strtoupper($row['5']) != crosCekPresensi($presensiSinkron->tgl_05)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_05 = 'X';
                    $ketTidakCocok .= " 5,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_05) != 1){
                    $presensiSinkron->hasil_tgl_05 = 'A';
                }

                if(strtoupper($row['6']) != crosCekPresensi($presensiSinkron->tgl_06)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_06 = 'X';
                    $ketTidakCocok .= " 6,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_06) != 1){
                    $presensiSinkron->hasil_tgl_06 = 'A';
                }

                if(strtoupper($row['7']) != crosCekPresensi($presensiSinkron->tgl_07)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_07 = 'X';
                    $ketTidakCocok .= " 7,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_07) != 1){
                    $presensiSinkron->hasil_tgl_07 = 'A';
                }

                if(strtoupper($row['8']) != crosCekPresensi($presensiSinkron->tgl_08)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_08 = 'X';
                    $ketTidakCocok .= " 8,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_08) != 1){
                    $presensiSinkron->hasil_tgl_08 = 'A';
                }

                if(strtoupper($row['9']) != crosCekPresensi($presensiSinkron->tgl_09)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_09 = 'X';
                    $ketTidakCocok .= " 9,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_09) != 1){
                    $presensiSinkron->hasil_tgl_09 = 'A';
                }

                if(strtoupper($row['10']) != crosCekPresensi($presensiSinkron->tgl_10)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_10 = 'X';
                    $ketTidakCocok .= " 10,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_10) != 1){
                    $presensiSinkron->hasil_tgl_10 = 'A';
                }

                if(strtoupper($row['11']) != crosCekPresensi($presensiSinkron->tgl_11)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_11 = 'X';
                    $ketTidakCocok .= " 11,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_11) != 1){
                    $presensiSinkron->hasil_tgl_11 = 'A';
                }

                if(strtoupper($row['12']) != crosCekPresensi($presensiSinkron->tgl_12)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_12 = 'X';
                    $ketTidakCocok .= " 12,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_12) != 1){
                    $presensiSinkron->hasil_tgl_12 = 'A';
                }

                if(strtoupper($row['13']) != crosCekPresensi($presensiSinkron->tgl_13)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_13 = 'X';
                    $ketTidakCocok .= " 13,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_13) != 1){
                    $presensiSinkron->hasil_tgl_13 = 'A';
                }

                if(strtoupper($row['14']) != crosCekPresensi($presensiSinkron->tgl_14)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_14 = 'X';
                    $ketTidakCocok .= " 14,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_14) != 1){
                    $presensiSinkron->hasil_tgl_14 = 'A';
                }

                if(strtoupper($row['15']) != crosCekPresensi($presensiSinkron->tgl_15)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_15 = 'X';
                    $ketTidakCocok .= " 15,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_15) != 1){
                    $presensiSinkron->hasil_tgl_15 = 'A';
                }

                if(strtoupper($row['16']) != crosCekPresensi($presensiSinkron->tgl_16)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_16 = 'X';
                    $ketTidakCocok .= " 16,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_16) != 1){
                    $presensiSinkron->hasil_tgl_16 = 'A';
                }

                if(strtoupper($row['17']) != crosCekPresensi($presensiSinkron->tgl_17)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_17 = 'X';
                    $ketTidakCocok .= " 17,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_17) != 1){
                    $presensiSinkron->hasil_tgl_17 = 'A';
                }

                if(strtoupper($row['18']) != crosCekPresensi($presensiSinkron->tgl_18)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_18 = 'X';
                    $ketTidakCocok .= " 18,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_18) != 1){
                    $presensiSinkron->hasil_tgl_18 = 'A';
                }

                if(strtoupper($row['19']) != crosCekPresensi($presensiSinkron->tgl_19)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_19 = 'X';
                    $ketTidakCocok .= " 19,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_19) != 1){
                    $presensiSinkron->hasil_tgl_19 = 'A';
                }

                if(strtoupper($row['20']) != crosCekPresensi($presensiSinkron->tgl_20)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_20 = 'X';
                    $ketTidakCocok .= " 20,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_20) != 1){
                    $presensiSinkron->hasil_tgl_20 = 'A';
                }

                if(strtoupper($row['21']) != crosCekPresensi($presensiSinkron->tgl_21)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_21 = 'X';
                    $ketTidakCocok .= " 21,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_21) != 1){
                    $presensiSinkron->hasil_tgl_21 = 'A';
                }

                if(strtoupper($row['22']) != crosCekPresensi($presensiSinkron->tgl_22)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_22 = 'X';
                    $ketTidakCocok .= " 22,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_22) != 1){
                    $presensiSinkron->hasil_tgl_22 = 'A';
                }

                if(strtoupper($row['23']) != crosCekPresensi($presensiSinkron->tgl_23)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_23 = 'X';
                    $ketTidakCocok .= " 23,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_23) != 1){
                    $presensiSinkron->hasil_tgl_23 = 'A';
                }

                if(strtoupper($row['24']) != crosCekPresensi($presensiSinkron->tgl_24)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_24 = 'X';
                    $ketTidakCocok .= " 24,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_24) != 1){
                    $presensiSinkron->hasil_tgl_24 = 'A';
                }

                if(strtoupper($row['25']) != crosCekPresensi($presensiSinkron->tgl_25)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_25 = 'X';
                    $ketTidakCocok .= " 25,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_25) != 1){
                    $presensiSinkron->hasil_tgl_25 = 'A';
                }

                if(strtoupper($row['26']) != crosCekPresensi($presensiSinkron->tgl_26)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_26 = 'X';
                    $ketTidakCocok .= " 26,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_26) != 1){
                    $presensiSinkron->hasil_tgl_26 = 'A';
                }

                if(strtoupper($row['27']) != crosCekPresensi($presensiSinkron->tgl_27)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_27 = 'X';
                    $ketTidakCocok .= " 27,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_27) != 1){
                    $presensiSinkron->hasil_tgl_27 = 'A';
                }

                if(strtoupper($row['28']) != crosCekPresensi($presensiSinkron->tgl_28)){
                    $tidakCocok = $tidakCocok + 1;
                    $presensiSinkron->hasil_tgl_28 = 'X';
                    $ketTidakCocok .= " 28,";
                }else if(cekPresensiLengkap($presensiSinkron->tgl_28) != 1){
                    $presensiSinkron->hasil_tgl_28 = 'A';
                }

                if($lamaHari > 28){
                    if(strtoupper($row['29']) != crosCekPresensi($presensiSinkron->tgl_29)){
                        $tidakCocok = $tidakCocok + 1;
                        $presensiSinkron->hasil_tgl_29 = 'X';
                        $ketTidakCocok .= " 29,";
                    }else if(cekPresensiLengkap($presensiSinkron->tgl_29) != 1){
                        $presensiSinkron->hasil_tgl_29 = 'A';
                    }

                    if(strtoupper($row['30']) != crosCekPresensi($presensiSinkron->tgl_30)){
                        $tidakCocok = $tidakCocok + 1;
                        $presensiSinkron->hasil_tgl_30 = 'X';
                        $ketTidakCocok .= " 30,";
                    }else if(cekPresensiLengkap($presensiSinkron->tgl_30) != 1){
                        $presensiSinkron->hasil_tgl_30 = 'A';
                    }

                    if($lamaHari > 30){
                        if(strtoupper($row['31']) != crosCekPresensi($presensiSinkron->tgl_31)){
                            $tidakCocok = $tidakCocok + 1;
                            $presensiSinkron->hasil_tgl_31 = 'X';
                            $ketTidakCocok .= " 31,";
                        }else if(cekPresensiLengkap($presensiSinkron->tgl_31) != 1){
