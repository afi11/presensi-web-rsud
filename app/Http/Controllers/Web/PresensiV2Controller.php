    ...
    public function fetchHistoryPresensi(Request $request)
    {
        ...
        foreach($logPresensi as $row){
            array_push($data, [
                ...
                'TL-1' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 1),
                'TL-2' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 2),
                'TL-3' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 3),
                'TL-4' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 4),
                'TL-1' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 1),
                'TL-2' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 2),
                'TL-3' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 3),
                'TL-4' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-masuk", 4),
                'PSW-1' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-pulang", 5),
                'PSW-2' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-pulang", 6),
                'PSW-3' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-pulang", 7),
                'PSW-4' => sumTelatTLPSW($request->ruangan, $row->code, $bulan,  $tahun, "jam-pulang", 8),
                'nTL1' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-masuk", 1),
                'nTL2' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-masuk", 2),
                'nTL3' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-masuk", 3),
                'nTL4' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-masuk", 4),
                'nPSW1' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-pulang", 5),
                'nPSW2' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-pulang", 6),
                'nPSW3' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-pulang", 7),
                'nPSW4' => hitungJumlahTLPSW($request->ruangan,$row->code, $bulan,  $tahun, "jam-pulang", 8),
